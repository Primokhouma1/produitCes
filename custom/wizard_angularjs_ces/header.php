			...
			<div class="container-fluid">
				...
				<div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<?php } ?>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="nouveau_devis_ces.php" title="Création d'un devis clim">Nouveau devis</a>
                        </li>
						<li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="<?php print DOL_MAIN_URL_ROOT;?>/comm/propal/list.php?leftmenu=propals" title="Liste de mes devis" target="_blank">Mes affaires</a>
                        </li>
                        <!--						<li class="nav-item">-->
